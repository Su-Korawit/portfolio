module.exports = {
  th: {
    ...
    cookieLifetimeThirdParty: 'YouTube เป็นผู้กำหนด',
    cookiePurposeAdmin: 'login ของผู้ดูแล ส่งเฉพาะ path /admin',
    cookiePurposeLang: 'จำภาษาล่าสุดที่อ่าน ใช้ตอนเข้า /',
    cookiePurposeConsent: 'จำคำตอบของผู้อ่านเรื่องคุกกี้ที่ต้องขอความยินยอม หรือจำว่ารับทราบแล้ว',
    cookiePurposeGa: 'สถิติผู้เข้าชม มีเฉพาะหลังผู้อ่านกดยอมรับ',
    cookiePurposeYouTube: 'เล่นวิดีโอที่ฝังในหน้าเกี่ยวกับ มีเฉพาะหลังผู้อ่านกดยอมรับ',
    ...
    cookieCategoryEmbed: 'วิดีโอฝัง ต้องได้รับความยินยอม',
    ...
    consentTextEmbed: 'เว็บนี้ขอฝังวิดีโอจาก YouTube ซึ่ง YouTube อาจตั้งคุกกี้ของตัวเอง อ่านรายละเอียดที่',
    consentTextBoth: 'เว็บนี้ขอใช้คุกกี้เพื่อวัดผลการเข้าชมแบบไม่ระบุตัวตน และขอฝังวิดีโอจาก YouTube ซึ่งอาจตั้งคุกกี้ของตัวเอง อ่านรายละเอียดที่',
  ...
  en: {
    ...
    cookieLifetimeThirdParty: 'Set by YouTube',
    ...
    cookiePurposeConsent: 'Remembers the reader\u2019s answer about cookies that need consent, or that they acknowledged the notice',
    cookiePurposeGa: 'Visitor statistics, set only after the reader accepts',
    cookiePurposeYouTube: 'Plays the video embedded on the about page, set only after the reader accepts',
    ...
    cookieCategoryEmbed: 'Embedded video, requires consent',
    ...
    consentTextEmbed: 'This site would like to embed a video from YouTube, which may set cookies of its own. Read more on the',
    consentTextBoth: 'This site would like to use cookies to measure anonymous visits, and to embed a video from YouTube, which may set cookies of its own. Read more on the',
